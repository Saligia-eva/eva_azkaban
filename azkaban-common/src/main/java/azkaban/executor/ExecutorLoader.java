...
public interface ExecutorLoader {
  ...
  /**
   *<pre>
   *   获取所有处于 backup 状态的执行机器
   *</pre>
   *
   *@author dongtao
   *@return node id collector list(id)
   */
  List<Integer> fetchAllBackupExecutorIds()
    throws ExecutorManagerException;
   ...
   *
   *@author dongtao
   *@return map(user,  node id collector)
   */
  HashMap<String, HashSet<Integer>> fetchAllExecutorUsers()
          throws ExecutorManagerException;
   ...
   */
  HashMap<String, String> fetchAzkabanEnvByGroup(String groupName)
          throws ExecutorManagerException;
