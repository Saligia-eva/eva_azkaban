...
public class ExecutableFlow extends ExecutableFlowBase {
  ...
  public static final String FLOWOWNUSER = "flowOwnUser";
  public static final String FLOWOWNGROUP = "flowOwnGroup";
  ...
  private String flowOwnUser;
  private String flowOwnGroup;
  ...
  public void getProjectOwner(Project project){

    for(Pair<String ,Permission> userPermission : project.getUserPermissions()){
      // flowOwnUser = userPermission.getFirst();
      // break;
     flowOwnUser = userPermission.getFirst();
     break;
    }

    if(project.getGroupPermissions().size() == 1){
      flowOwnGroup = project.getGroupPermissions().get(0).getFirst();
    }
  ...
  public String getFlowOwnUser() {
    return flowOwnUser;
  }

  public void setFlowOwnUser(String flowOwnUser) {
    this.flowOwnUser = flowOwnUser;
  }

  public String getFlowOwnGroup() {
    return flowOwnGroup;
  }

  public void setFlowOwnGroup(String flowOwnGroup) {
    this.flowOwnGroup = flowOwnGroup;
  }
  ...
  public Map<String, Object> toObject() {
    ...
    flowObj.put(SCHEDULE_TIME, scheduleTime);
    ...
    flowObj.put(FLOWOWNUSER, flowOwnUser);
    flowObj.put(FLOWOWNGROUP, flowOwnGroup);
  ...
  public void fillExecutableFromMapObject(
    ...
    this.flowOwnUser = flowObj.getString(FLOWOWNUSER);
    this.flowOwnGroup = flowObj.getString(FLOWOWNGROUP);

    if(flowObj.containsKey(SCHEDULE_TIME)) {
      this.scheduleTime = flowObj.getString(SCHEDULE_TIME);
    }
