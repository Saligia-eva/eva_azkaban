...
public class AzkabanExecutorServer {
  ...
  private final ExecutorLoader executionLoader;    // executor 信息加载管理
  private final ProjectLoader projectLoader;       // project 信息加载管理
  private final FlowRunnerManager runnerManager;   // work flow 运行管理机制
  private final Props props;
  private final Server server;                     // 负责交互的 executor 服务器
